      ...
      >
        ...
        {(!artifact.plan_tier || artifact.plan_tier === "free") && (
          <a
            ...
            className="fixed bottom-4 left-2 sm:left-4 z-40 flex items-center gap-1.5 px-2 py-1 rounded-full bg-black/20 backdrop-blur-sm opacity-60 hover:opacity-90 transition-opacity"
          >
